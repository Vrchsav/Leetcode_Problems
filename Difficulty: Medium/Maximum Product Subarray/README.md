...
<pre><span style="font-size: 18px;"><strong>Input:</strong> arr[] = [-1, -3, -10, 0, 60]
<strong>Output:</strong> 60
<strong>Explanation:</strong> The subarray with maximum product is {60}.</span></pre>
<pre><span style="font-size: 18px;"><strong>Input: </strong>arr[] = [2, 3, 4]<br><strong>Output:</strong> 24<br></span><span style="font-size: 18px;"><strong>Explanation:</strong> For an array with all positive elements, the result is product of all elements. </span></pre>
